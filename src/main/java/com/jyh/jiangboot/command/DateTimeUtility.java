...
public class DateTimeUtility {
    ...
    public static void main(String[] args) {
        System.out.println(DateTimeUtility.formatYYYYMMDDHHMMSS(DateTimeUtility.addYears(new Date(), -10)));
        System.out.println(DateTimeUtility.formatYYYYMMDDHHMMSS(DateTimeUtility.getFirstDayOfYear(new Date())));
    }
