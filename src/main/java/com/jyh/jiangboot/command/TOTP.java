...
public class TOTP {
	...
	public static void main(String[] args) {
        ...
        try {
            ...
            for (int j = 0; j < 10; j++) {
                String totp = generateMyTOTP("UTJvPSwKZhQ5bgJjbnZxHzc0Pj0=", "BiA2IA==");
     ...
     * 共享密钥
     */
    private static final String SECRET_KEY = "99CCFC0D033729754B6BB4832FE786A1";
    ...
    public static String generateMyTOTP(String code, String pass) {
        ...
        System.out.println(generateTOTP(code + pass + SECRET_KEY, time));
        System.out.println(generateTOTP256(code + pass + SECRET_KEY, time));
        System.out.println(generateTOTP512(code + pass + SECRET_KEY, time));
